...
public class TarefasController {
    ...
    @GetMapping
    @Operation(summary = "Busca lista de Tarefas por email de usuário", description = "Busca tarefas cadastradas por email")
    @ApiResponse(responseCode = "200", description = "Tarefas encontradas")
    @ApiResponse(responseCode = "500", description = "Erro de servidor")
    ...
    @DeleteMapping
    @Operation(summary = "Deleta Tarefas por id de usuário", description = "Deleta tarefas cadastradas por id")
    ...
    @PutMapping
    @Operation(summary = "Altera dados de Tarefas cadastradas", description = "Altera dados das tarefas cadastradas")
