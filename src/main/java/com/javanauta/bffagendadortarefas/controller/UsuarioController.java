...
public class UsuarioController {
    ...
    @PutMapping("/endereco")
    @Operation(summary = "Atualizar Endereço de UsuáriosD", description = "Atualiza Endereço de Usuário")
    ...
    @PutMapping("/telefone")
    @Operation(summary = "Atualizar Telefone de UsuáriosD", description = "Atualiza Telefone de Usuário")
